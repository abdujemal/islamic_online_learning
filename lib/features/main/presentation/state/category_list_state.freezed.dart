...
class __$$EmptyImplCopyWithImpl<$Res>
    extends _$CategoryListStateCopyWithImpl<$Res, _$EmptyImpl>
...
class _$EmptyImpl implements _Empty {
  const _$EmptyImpl({required final List<String> courses}) : _courses = courses;
...
abstract class _Empty implements CategoryListState {
  const factory _Empty({required final List<String> courses}) = _$EmptyImpl;
