...
class ConstScore {
  ...
  static ConstScore? get(String title, WidgetRef ref, List<ConstScore> scores) {
    if (scores.isEmpty) {
      return null;
    }
  ...
  static List<ConstScore> listFromJson(String responseBody) {
    final parsed = jsonDecode(responseBody) as List<dynamic>;
    return parsed.map((json) => ConstScore.fromMap(json)).toList();
  }
  ...
  factory ConstScore.fromMap(Map<String, dynamic> map) {
    return ConstScore(
  ...
  factory ConstScore.fromJson(String source) =>
      ConstScore.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant ConstScore other) {
